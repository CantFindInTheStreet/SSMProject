...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#findActivity").keyup(function () {
			var activityName=$("#findActivity").val();
			var clueId='${requestScope.clue.id}';
			$.ajax({
				url:'workbench/clue/selectActivityForDetailByNameAndClueId',
				data:{
		...
		$("#relationBtn").click(function () {
			...
			str+="clueId=${requestScope.clue.id}";
			$.ajax({
		...
		$("#relationTBody").on("click","a",function () {
			...
			if(window.confirm("请问真的要解除关联吗？")){
				$.ajax({
					url:'workbench/clue/saveUnbund',
					data:{
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="findActivity" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
		...
		<div class="remarkDiv" id="div_${clueremark.id}" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				...
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" name="editRemark" remarkId="${clueremark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" name="deleteRemark" remarkId="${clueremark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
				</div>
			</div>
		</div>
	</c:forEach>
