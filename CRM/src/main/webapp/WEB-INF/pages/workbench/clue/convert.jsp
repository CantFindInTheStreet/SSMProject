...
<script type="text/javascript">
	$(function(){
		...
		$("#searchWindow").keyup(function () {
			var activityName=$("#searchWindow").val();
			var clueId='${requestScope.clue.id}';
			$.ajax({
				url:'workbench/clue/selectActivityForConvertByNameClueId',
				data:{
		...
		$("#saveConverCluwBtn").click(function () {
			var clueId='${clue.id}';
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input id="searchWindow" type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" id="saveConverCluwBtn" value="转换">
		&nbsp;&nbsp;&nbsp;&nbsp;
